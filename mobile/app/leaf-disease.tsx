  ...
  const pickImage = async (useCamera: boolean) => {
    ...
    if (!res.canceled) {
      ...
      try {
        ...
        Alert.alert("Error", "Leaf analysis failed.");
      } finally {
        setLoading(false);
      }
    }
          ...
          <View style={styles.resultSection}>
            ...
            {loading && (
              <View style={styles.loadingBox}>
                ...
                <Text style={styles.loadingText}>Analyzing Samples...</Text>
              </View>
            )}
            {result && (
                          ...
                          <View
                            style={[
                              ...
                              name === result.predicted_class
                                ? styles.probFillActive
                                : styles.probFillInactive,
                              { width: `${prob}%` },
                            ]}
                          />
                        </View>
